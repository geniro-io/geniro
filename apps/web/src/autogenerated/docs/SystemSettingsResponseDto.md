...
| ---------------------------- | ----------- | ---------------------------------------------------------------------------------- | ---------------------- |
| **githubAppEnabled**         | **boolean** | Whether the GitHub App is configured (all GITHUB*APP*\* env vars set)              | [default to undefined] |
| **githubUserPatEnabled**     | **boolean** | Whether per-user GitHub PAT storage is available (the secrets store is configured) | [default to undefined] |
