...
| [**getRuntimeState**](#getruntimestate) | **GET** /api/v1/runtimes/{id}/state |             |
...
> RuntimeInstanceStateDto getRuntimeState()
...
const { status, data } = await apiInstance.getRuntimeState(id);
```
